...
export default async function PublicAgentPage({
 ...
 return (
 <div className="fixed inset-0 flex flex-col overflow-hidden bg-[#f7f7f5]">
 ...
 <div className="mx-auto w-full max-w-md rounded-2xl border border-border-warm bg-bg-surface p-8 text-center shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
 <h1 className="font-sans text-2xl font-normal text-text-primary">
 {agent.name}
 </h1>
