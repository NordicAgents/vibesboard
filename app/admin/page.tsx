...
export default function AdminPage() {
 ...
 <CardHeader>
 <div className="mb-3 flex size-10 items-center justify-center rounded-xl bg-bg-hover">
 ...
 {item.title}
 <ArrowRight className="size-4 text-text-tertiary opacity-0 transition-opacity duration-150 group-hover:opacity-100" />
 </CardTitle>
