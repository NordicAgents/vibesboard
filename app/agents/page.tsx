...
export default function AgentsPage() {
 ...
 <CardTitle className="line-clamp-1 font-sans text-base font-normal text-text-primary">
 {agent.name}
 </CardTitle>
 <Bot className="size-5 shrink-0 text-accent-orange" />
 </div>
 <CardDescription className="line-clamp-2 text-sm text-text-secondary">
 ...
 disabled={page === 1}
 className="border-border-warm text-text-secondary hover:bg-bg-hover hover:text-text-primary disabled:opacity-40"
 >
