  ...
  return (
    <main className="min-h-screen bg-beige-bg text-black-primary selection:bg-black-primary selection:text-beige-bg dark:bg-background dark:text-foreground dark:selection:bg-white dark:selection:text-black">
      ...
      <div className="container mx-auto px-4 py-24 sm:px-6 sm:py-32">
        <h1 className="mb-8 font-switzer text-4xl font-bold sm:text-5xl">Terms of Service</h1>
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          <h2>2. Use License</h2>
          <p>
            Permission is granted to temporarily download one copy of the materials (information or software) on vibesboard's website for personal,
            non-commercial transitory viewing only. This is the grant of a license, not a transfer of title.
          </p>

          <h2>3. Disclaimer</h2>
          <p>
            The materials on vibesboard's website are provided on an 'as is' basis. vibesboard makes no warranties, expressed or implied,
          ...
          <h2>4. Limitations</h2>
          <p>
            In no event shall vibesboard or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit,
            or due to business interruption) arising out of the use or inability to use the materials on vibesboard's website.
          </p>
