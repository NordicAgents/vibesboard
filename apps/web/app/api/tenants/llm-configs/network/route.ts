...
export async function PATCH(request: NextRequest) {
  ...
  if (parsed.data.llmAllowPrivateHosts !== undefined) patch.llmAllowPrivateHosts = parsed.data.llmAllowPrivateHosts
  if (parsed.data.llmHostAllowlist !== undefined) patch.llmHostAllowlist = parsed.data.llmHostAllowlist
