        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              ...
              {new Date(invitation.expires_at).toLocaleDateString()}. Please
              contact the tenant administrator for a new invitation.
            </p>
          </CardContent>
          <CardFooter>
            <Button asChild className="w-full">
            ...
            {!isAuthenticated ? (
              <div className="space-y-3">
                ...
                <div className="flex flex-col gap-2">
                  <Button asChild className="w-full">
                    <Link
                      href={`/sign-in?redirectedFrom=${encodeURIComponent(`/invite/${token}`)}`}
                    >
                      Sign In to Accept
                    </Link>
                  </Button>
                  <Button asChild variant="outline" className="w-full">
                    <Link
                      href={`/sign-up?redirectedFrom=${encodeURIComponent(`/invite/${token}`)}`}
                    >
                      Create Account
                    </Link>
                  </Button>
