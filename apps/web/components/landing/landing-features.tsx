  ...
  const features = [
    {
      title: 'Build Agents',
      description:
        'Create custom AI agents tailored to your needs. Design conversation flows, set personalities, and configure behaviors that match your goals.'
    },
    {
      title: 'Record Vibes',
      description:
        'Capture authentic interactions as your agents engage with people. Every conversation, response, and nuance is recorded for deep analysis.'
    },
    {
      title: 'AI Insights',
      description:
        'Unlock the real vibe with advanced AI analysis. Understand sentiment, detect patterns, and gain insights that matter from every interaction.'
    }
  ]
      ...
      <div className="container mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="mx-auto mb-16 max-w-4xl text-center md:mb-20">
          ...
          <p className="font-switzer text-lg text-gray-secondary md:text-xl">
            Build, deploy, and analyze AI agents that capture authentic human
            interactions
          </p>
        </div>
