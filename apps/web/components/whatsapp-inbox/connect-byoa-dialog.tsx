...
export function ConnectByoaDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setConnecting(true)
    try {
      const res = await fetch('/api/whatsapp-inbox/auth/byoa', {
        method: 'POST',
      ...
      toast.success('WhatsApp Business Account connected via BYOA!')
      onSuccess?.()
    } catch (err: any) {
          ...
          <div className="space-y-4">
            ...
            <div className="bg-bg-hover/50 space-y-2 rounded-lg border border-border p-3 text-sm text-text-secondary">
              ...
              <ol className="list-inside list-decimal space-y-1">
                ...
                <li>Go to WhatsApp &gt; Configuration &gt; Webhook</li>
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-h-[85vh] max-w-lg overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="byoa-app-id">Meta App ID</Label>
            <Input
              id="byoa-app-id"
          ...
          <div className="space-y-2">
            <Label htmlFor="byoa-app-secret">Meta App Secret</Label>
            <Input
              id="byoa-app-secret"
              type="password"
          ...
          <div className="space-y-2">
            <Label htmlFor="byoa-token">System User Access Token</Label>
            <Input
              id="byoa-token"
              type="password"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label htmlFor="byoa-verify-token">Webhook Verify Token</Label>
              <Button
                type="button"
                variant="ghost"
                size="sm"
          ...
          <div className="space-y-2">
            <Label htmlFor="byoa-waba-id">WABA ID</Label>
            <Input
              id="byoa-waba-id"
              placeholder="123456789012345"
              value={wabaId}
