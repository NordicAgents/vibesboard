...
export function AgentAskChat({
 ...
 <p className="font-switzer text-sm font-semibold uppercase tracking-[0.4em] text-black-primary">
 ASK AI
 </p>
 ...
 <div className="flex items-center justify-center gap-2 px-4 py-2 text-sm text-text-tertiary">
 ...
 {pendingMessages.length > 0 && (
 <div className="sticky bottom-0 border-t border-border-warm bg-[#f7f7f5]/95 backdrop-blur-sm/95">
