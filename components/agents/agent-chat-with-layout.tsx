...
export function AgentChatWithLayout({
 ...
 <DashboardSidebar>
 {/* Agent Info */}
 <div className="mb-4 rounded-xl border border-border-warm bg-[#e6ede6]/40 p-4 dark:bg-[#344348]/40">
 <h3 className="truncate font-sans text-base font-medium tracking-tight text-text-primary">
 {agent.name}
 </h3>
 </div>

 {!canEdit && (
 <div className="mb-4 rounded-lg border border-dashed border-border-warm bg-[#e6ede6]/30 px-4 py-3 text-sm text-text-secondary dark:bg-[#344348]/20">
 ...
 <div className="rounded-lg border border-dashed border-border-warm px-3 py-2 text-sm text-text-tertiary">
 ...
 data-mobile-menu-close="true"
 className="flex size-5 items-center justify-center rounded text-xs text-text-tertiary transition-colors hover:text-text-primary"
 ...
 <div className="h-full bg-[#f7f7f5]">
 <ConversationView
 ...
 <div className="h-full overflow-y-auto bg-[#f7f7f5] p-4">
 <AgentRightbar
 agent={agent}
 share={share}
 ...
 <div className="rounded-xl border border-border-warm bg-bg-surface p-6">
 <h1 className="font-sans text-xl font-medium tracking-tight text-text-primary">
 Read-only access
 </h1>
