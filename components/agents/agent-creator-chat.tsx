...
export function AgentCreatorChat({
 ...
 <p className="font-switzer text-xs font-medium uppercase tracking-[0.08em] text-text-tertiary">
 Agent Builder
 </p>
 ...
 <h1 className="font-switzer text-4xl font-bold tracking-tight text-black-primary md:text-5xl">
 Build Your Agent
 </h1>
 <Button
 size="sm"
 ...
 <div className="rounded-2xl border border-border-warm bg-bg-surface px-4 py-3 shadow-soft">
 <PromptForm
 ...
 size="sm"
 onClick={() => stop()}
 className="rounded-full border-border-warm font-switzer text-text-secondary hover:bg-bg-hover hover:text-text-primary"
 >
 ...
 <div className="flex items-center justify-between gap-3 rounded-xl border border-border-warm bg-bg-hover px-3 py-2 text-xs text-text-primary">
 ...
 <div className="flex w-12 shrink-0 items-center justify-center border-l border-border-warm transition-all duration-300 ease-in-out">
 <Button
 size="sm"
 variant="ghost"
