...
export function AgentSchedulingSettings({
  ...
  const showSource = section !== 'behavior'
  const showBehavior = section !== 'source'
      ...
      {showSource && (
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Connect one Google Calendar for appointments and meetings. This is
              separate from room booking calendars.
            </CardDescription>
          </CardHeader>
      ...
      {showBehavior && (
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Set how the agent offers appointment slots after you choose the
              scheduling calendar.
            </CardDescription>
          </CardHeader>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  !current.calendarConnectionId
                    ...
                    : 'Agent can check appointment availability and book meetings.'}
                </p>
              </div>
              <Switch
