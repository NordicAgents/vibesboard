...
export function PublicAgentExperience({
 ...
 className="flex flex-1 items-center justify-center bg-[#f7f7f5] p-6"
 >
 <div className="mx-auto flex w-full max-w-md flex-col items-center gap-6 rounded-3xl border border-border-warm bg-bg-surface p-10 text-center shadow-[0_8px_40px_rgba(0,0,0,0.10)]">
 <motion.div
 initial={{ scale: 0 }}
 animate={{ scale: 1 }}
 transition={{
 ...
 <h2 className="font-sans text-2xl font-medium tracking-tight text-text-primary">
 Thanks for vibing!
 </h2>
 ...
 className="flex min-h-0 flex-1 flex-col overflow-hidden bg-[#f7f7f5]"
 >
 {/* Agent header — full width, content centered */}
 <div className="shrink-0 border-b border-border-warm/70 bg-[#f5f8f7]/80 backdrop-blur-sm dark:bg-[#192425]/80">
 <div className="mx-auto flex w-full max-w-[760px] items-center gap-3 px-4 py-3 sm:px-6">
 {/* Agent logo */}
 <div className="flex size-9 shrink-0 items-center justify-center overflow-hidden rounded-full border border-border-warm bg-bg-surface shadow-[0_1px_4px_rgba(0,0,0,0.08)]">
