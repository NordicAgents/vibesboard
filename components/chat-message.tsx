...
export function ChatMessage({
 ...
 <div className="max-w-[88%] rounded-[18px] bg-bg-surface px-4 py-2.5 text-[15px] leading-[1.65] text-text-primary sm:max-w-[72%]">
 ...
 {/* AI avatar */}
 <div className="mt-0.5 flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-full border border-border-warm bg-bg-surface shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
 ...
 <div className="rounded-none border border-border-warm bg-bg-surface p-4 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
 <Tabs defaultValue={defaultTab} className="w-full">
 <TabsList className="mb-3 w-full justify-start bg-bg-hover dark:bg-[#253435]">
 {structured.overview && (
 ...
 <div className="text-[15px] leading-[1.65] text-text-primary">
 <ChatMarkdown>{message.content}</ChatMarkdown>
 </div>
 )}
