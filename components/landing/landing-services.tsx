...
export function LandingServices() {
    return (
        <section id="services" className="py-20 px-6 bg-beige-bg border-t border-black-primary/5">
                ...
                <div className="grid grid-cols-1 gap-0">
                    {services.map((service, index) => (
                        <FadeIn key={service.id} delay={0.1 + (index * 0.1)} direction="left">
                            <div className="group border-t border-black-primary/10 py-12 transition-colors hover:bg-white/50 cursor-default">
                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                                    <div className="flex items-baseline gap-8 mb-4 md:mb-0">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-switzer font-medium">{service.title}</h3>
                                    </div>
                                    <div className="flex items-center gap-8">
                                        ...
                                        <div className="w-10 h-10 rounded-full border border-black-primary/20 flex items-center justify-center group-hover:bg-black-primary group-hover:text-white transition-all duration-300">
                    ...
                    <div className="border-t border-black-primary/10"></div>
                </div>
            </div>
        </section>
    )
