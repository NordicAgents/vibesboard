...
export function LandingTestimonials() {
  const testimonials = [
    {
      quote:
        'VibesBoard transformed how we understand our customers. The AI insights revealed patterns we never knew existed.',
      author: 'Sarah Chen',
      role: 'Product Manager, TechCorp'
    },
    {
      quote:
        'The ability to capture authentic conversations and analyze them at scale has been a game-changer for our research team.',
      author: 'Michael Rodriguez',
      role: 'UX Researcher, DesignLab'
    },
    {
      quote:
        "We've built agents that feel natural and engaging. The vibe analysis helps us understand what really resonates with people.",
      author: 'Emily Watson',
