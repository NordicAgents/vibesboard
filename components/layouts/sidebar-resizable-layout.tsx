...
export function SidebarResizableLayout({
 ...
 <aside
 className={cn(
 'hidden flex-col border-r border-border-warm bg-bg-surface lg:flex',
 ...
 <Link
 href="/"
 className="ml-2 font-sans text-base font-medium tracking-tight text-text-primary transition-colors hover:text-[#7e8e8f]"
 >
 vibesboard
 </Link>
 <TooltipProvider>
 ...
 <Button
 asChild
 className="h-10 w-full justify-start border-0 bg-text-primary px-4 text-white shadow-none hover:bg-[#344348] dark:text-[#111918] dark:hover:bg-[#e6ede6]"
 >
 <Link href="/agents/create-chat">
 ...
 <div
 className={cn(
 'shrink-0 border-t border-border-warm p-2',
 isSidebarOpen
 ...
 <SheetContent
 side="left"
 className="w-[280px] border-r border-border-warm bg-bg-surface p-0"
 >
 ...
 : 'text-text-tertiary hover:bg-[#f5f8f7]/50 dark:hover:bg-[#192425]/50'
 )}
 >
 Agents
 </button>
