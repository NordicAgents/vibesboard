...
export function SidebarAgentGroup({
 ...
 className="absolute right-1 top-1/2 size-6 -translate-y-1/2 text-text-tertiary hover:bg-bg-hover hover:text-text-secondary"
 onClick={e => {
 e.preventDefault()
 e.stopPropagation()
 ...
 <div className="ml-5 space-y-0.5 border-l border-border-warm pl-2">
 {items.map(session => {
