...
export async function SidebarList({ userId }: SidebarListProps) {
 ...
 <p className="px-4 text-sm text-text-tertiary">
 ...
 {whatsappBulkEnabled && (
 <div className="space-y-2 border-t border-border-warm py-4">
 <div className="flex items-center justify-between px-4">
 <span className="text-[11px] font-medium uppercase tracking-[0.08em] text-text-tertiary">
 WhatsApp Marketing
 </span>
...
function WhatsAppNavLink({
 ...
 >
 <Icon className="size-4 text-text-tertiary transition-colors duration-150 group-hover:text-accent-orange" />
 {children}
 </Link>
 )
}
