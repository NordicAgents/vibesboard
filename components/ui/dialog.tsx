...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 grid w-full gap-4 rounded-b-xl border border-[#E2DDD4] bg-[#FDFAF5] p-6 shadow-[0_8px_32px_rgba(26,25,21,0.12)] animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:max-w-lg sm:rounded-2xl sm:zoom-in-90 data-[state=open]:sm:slide-in-from-bottom-0 dark:border-[#2E2B25] dark:bg-[#221F1A]',
        className
      )}
      {...props}
    >
