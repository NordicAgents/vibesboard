import { SendMessageParams, BotResponse, WhatsAppAPIResponse } from "./message-types";
...
export async function sendWhatsAppMessage(
  ...
  try {
    ...
    console.log("✅ Message sent successfully. Message ID:", responseData.messages?.[0]?.id);
    return responseData;
  } catch (error) {
