import type { ActionModule, ActionContext, AgentAction } from './types.ts'
import type { RegisteredTool } from '@vibesboard/ai/tools/base'
import type { VibeAgent } from '@vibesboard/contracts'
import { isFeatureEnabled } from '@vibesboard/policy/features'
import { AppointmentsModule } from './appointments/index.ts'
import { BookingModule } from './booking/index.ts'
