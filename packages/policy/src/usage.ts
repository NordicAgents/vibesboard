...
import { Collections, type UsageSource } from '@vibesboard/contracts'
import {
  getPlanTemplate,
  computeMessageLimit,
  type PlanId
...
// usageLimitResponse moved to apps/web/lib/usage.ts — it returns a
// NextResponse, which is framework-coupled and belongs in the app layer,
// not in @vibesboard/policy.
